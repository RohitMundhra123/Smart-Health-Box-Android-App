...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    private void receive(ArrayDeque<byte[]> datas) {
        ...
        for (byte[] data : datas) {
            packetBuilder.append(new String(data));
        }
        String packet = packetBuilder.toString();

        String[] sensorValues = packet.split(",");
        if (sensorValues.length == 3) {
            // extract the sensor values from the packet
            String sensor1Value = sensorValues[0];
            String sensor2Value = sensorValues[1];
            String sensor3Value = sensorValues[2];
...
//    private void saveInfo(String temp, String spo, String pulse) {
//        String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
//        reference = firebaseDatabase.getReference("Health");
//        HashMap<String, String> userMap = new HashMap<String, String>();
//        userMap.put("temperature", temp);
...
//        intent.setClass(parentActivity, DashboardActivity.class);
